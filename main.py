...
class Caesar:
    ...
    def c_encrypt(self, plaintext, key):
        """This function encrypt plaintext using a Caesar cipher"""
        cipher = ""
    ...
    def c_decrypt(self, cipher, key):
        """This function decrypt plaintext using a Caesar cipher"""
        plaintext = ""
...
class Vigenere:
    ...
    def v_encrypt(self, plaintext, key):
        """This function encrypt plaintext using a Vigenere cipher"""
        cipher = ""
        j = 0
        for i in range(len(plaintext)):
            char = plaintext[i]
    ...
    def v_decrypt(self, cipher, key):
        """This function decrypt plaintext using a Vigenere cipher"""
        plaintext = ""
        j = 0
        for i in range(len(cipher)):
            char = cipher[i]
...
class Columnar:
    def col_encrypt(self, plaintext, key):
        """This function encrypt plaintext using a Columnar cipher"""
    ...
    def col_decrypt(self, cipher, key):
        """This function decrypt plaintext using a Columnar cipher"""
...
class Playfair:
    ...
    def create_table(self, key):
        """This function crete a table for bigrams combination"""
        keytext = []
        row = []
        table = []
    ...
    def pf_encrypt(self, plaintext, key):
        """This function encrypt plaintext using a Playfair cipher"""
        cipher = ""
    ...
    def pf_decrypt(self, cipher, key):
        """This function decrypt plaintext using a Playfair cipher"""
        plaintext = ""
...
def type_change(event):
    """This function handles file and cypher type change"""
...
window.title('Kryptea')
window.geometry("640x316")
window.resizable(True, True)
image_icon = PhotoImage(file="Kryptea-logos_black.png")
window.iconphoto(False, image_icon)
# screen.title("Kryprtea")
...
key_text = StringVar()
key_entry = Entry(window, textvariable=key_text, width=10)
key_entry.grid(row=1, column=1, sticky="w")

first_label = Label(window, text='Plaintext')
first_label.grid(row=2, column=0, padx=10, pady=10, columnspan=2, sticky="w")
before_text = StringVar()
before_entry = Entry(window, textvariable=before_text, width=50)
before_entry.grid(row=3, column=0, columnspan=2, padx=10, ipady=30, sticky="w")
...
after_entry = Entry(window, textvariable=after_text, state='readonly', width=50)
after_entry.grid(row=3, column=2, columnspan=2, ipady=30, sticky="w")


def open_file():
    """This function open Windows explorer and chooses a file to encrypt/Decrypt"""
...
def open_dir():
    """This function open Windows explorer and chooses a folder to encrypt/Decrypt"""
    enc_text_array.clear()
    dec_text_array.clear()
    file_names.clear()
    plain_text_array.clear()
...
def save_enc():
    """This function gives the user the option to 'save as' an encrypted file to a chosen directory"""
...
def save_dec():
    """This function gives the user the option to 'save as' a decrypted file to a chosen directory"""
    if combobox2.get() == "File":
        if dec_text_array:
            filename = asksaveasfilename(defaultextension=".py",
                                         filetypes=[("Text files", ".txt"), ("Python files", ".py"),
...
def onclick_encrypt():
    """This function is for an event listener when the user clicks the encrypt button"""
...
def onclick_decrypt():
    """This function is for an event listener when the user clicks the decrypt button"""
    after_entry.configure(state='normal')
